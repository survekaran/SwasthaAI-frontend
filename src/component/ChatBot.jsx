...
export default function ChatBot() {
  ...
  const sendMessage = () => {
    ...
    setInput("");
    setTimeout(() => {
      setMessages((prev) => [...prev, { from: "bot", text: "This is a demo response. AI integration coming soon!" }]);
    }, 800);
  };
  ...
  return (
    <>
      <style>{`
        ...
        .chat-fab.closed { background: #1f2937; }
        .chat-fab.closed:hover { background: #374151; transform: scale(1.08); }
        .chat-fab.open {
          background: linear-gradient(135deg, #06b6d4, #0891b2);
          box-shadow: 0 4px 20px rgba(6,182,212,0.45);
        }
        .chat-fab.open:hover { transform: scale(1.08); }
        ...
        .chat-header-sub { font-size: 0.7rem; color: rgba(255,255,255,0.8); margin-top: 1px; }
        .chat-header-dot {
        ...
        .typing-dots { display: flex; gap: 4px; padding: 2px; align-items: center; }
        .typing-dots span {
